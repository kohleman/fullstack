...
let PostResolver = class PostResolver {
    ...
    updatePost(id, title, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
            const postToUpdate = yield em.findOne(Post_1.Post, { id });
            if (!postToUpdate) {
                return null;
            }
            postToUpdate.title = title;
            yield em.persistAndFlush(postToUpdate);
            return postToUpdate;
        });
    }
    deletePost(id, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
            const postToDelete = yield em.findOne(Post_1.Post, { id });
            if (!postToDelete) {
                return false;
            }
            yield em.removeAndFlush(postToDelete);
            return true;
        });
    }
};
